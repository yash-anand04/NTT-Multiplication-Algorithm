...
# Vivado Synthesis + Implementation for NTT Polynomial Multiplier
# =============================================================================

# ---- Setup Paths & Arguments -------------------------------------------------

set radix        [lindex $argv 0]
set n_degree     [lindex $argv 1]
set target_period [lindex $argv 2]
...
set out_dir    [file join $script_dir "results_r${radix}_n${n_degree}"]
...
puts "========================================================================="
puts "  NTT Synthesis Metrics Extraction"
puts "  Radix R = $radix, Degree N = $n_degree"
...
# Apply timing constraint after design is elaborated.
...
set cycle_key "${radix}:${n_degree}"

if {[dict exists $cycles_map $cycle_key]} {
    set cycles [dict get $cycles_map $cycle_key]
} else {
    set cycles 1000
}
...
puts $fp "# NTT Synthesis Metrics"
puts $fp "# R=$radix N=$n_degree"
...
puts ""
puts "========================================================================="
puts "SUMMARY: R=$radix N=$n_degree"
puts "========================================================================="
puts "LUT:        $lut_count"
puts "FF:         $ff_count"
puts "DSP:        $dsp_count"
