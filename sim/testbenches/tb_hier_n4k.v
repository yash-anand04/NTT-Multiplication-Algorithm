// =============================================================================
// tb_hier_n4k.v - testbench for Phase E debug variant at L=8, N=4096.
// =============================================================================
`timescale 1ns/1ps
...
module tb_hier_n4k;
    ...
    initial begin
        // Test 1: delta * delta -> delta
        for (i = 0; i < N; i = i + 1) begin in_a[i] = 0; in_b[i] = 0; exp_c[i] = 0; end
        in_a[0] = 17'h00001; in_b[0] = 17'h00001; exp_c[0] = 17'h00001;
        drive_one_test("delta_x_delta");

        // Test 2: identity (a = delta_0) -> c = b
        for (i = 0; i < N; i = i + 1) begin
            in_a[i] = 0; in_b[i] = 17'h00001 + i[16:0]; exp_c[i] = in_b[i];
        end
        in_a[0] = 17'h00001;
        ...
        // Test 5: random vs Python golden
        $readmemh("input_a_n4k.hex", in_a);
        $readmemh("input_b_n4k.hex", in_b);
        $readmemh("expected_hier_n4k.hex", exp_c);
