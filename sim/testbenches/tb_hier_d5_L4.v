// tb_hier_d5_L4.v - L=4, d=5, N=1024
`timescale 1ns/1ps
module tb_hier_d5_L4;
    ...
    initial begin
        ...
        // random vs golden
        $readmemh("input_a_hier_d5_L4.hex", in_a);
        $readmemh("input_b_hier_d5_L4.hex", in_b);
        $readmemh("expected_hier_d5_L4.hex", exp_c);
