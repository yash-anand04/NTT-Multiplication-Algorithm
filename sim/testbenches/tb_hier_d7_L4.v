// tb_hier_d7_L4.v - L=4, d=5, N=1024
`timescale 1ns/1ps
module tb_hier_d7_L4;
    localparam L = 4, N = L*L*L*L*L*L*L, WWIDTH = 17;
    ...
    hier_d7_L4_top #(.B(16)) dut (.clk(clk), .rst(rst), .start(start),
    ...
    endtask
    initial begin
        // identity: a = [1,0,...], b = arbitrary -> c = b
        ...
        // random vs golden
        $readmemh("input_a_hier_d7_L4.hex", in_a);
        $readmemh("input_b_hier_d7_L4.hex", in_b);
        $readmemh("expected_hier_d7_L4.hex", exp_c);
