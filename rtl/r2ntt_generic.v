// =============================================================================
// r2ntt_generic.v
// Generic R-point DIT-NTT core in D1 domain for R = 8/16 style configurations.
// - Full mode: computes R-point NTT using twiddle table values.
// - Mixed-radix mode (is_Rhat_stage): computes RHAT-point NTTs on interleaved
//   groups, matching the "first log(RHAT) substages" behavior.
// =============================================================================

module r2ntt_generic #(
    parameter B = 16,
    parameter N = 256,
    parameter R = 8
)(
    ...
    always @(*) begin
        ...
        if (is_Rhat_stage && USE_RHAT) begin
            // Mixed-radix stage: RHAT-point NTT across interleaved lanes.
